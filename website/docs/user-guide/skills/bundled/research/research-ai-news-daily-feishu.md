---
title: "Ai News Daily Feishu — Configure and run a scheduled AI-news digest for Feishu/Lark"
sidebar_label: "Ai News Daily Feishu"
description: "Configure and run a scheduled AI-news digest for Feishu/Lark"
---
...
Configure and run a scheduled AI-news digest for Feishu/Lark. Use this skill when the user asks to crawl, summarize, rank, or schedule the hottest AI news, especially requests like daily AI news at 00:00, send AI headlines to Feishu, create an AI news cron job, or test/repair the Feishu AI news digest.
...
| Path | `skills/research/ai-news-daily-feishu` |
