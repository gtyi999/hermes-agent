...
OPTIONAL_ENV_VARS = {
    ...
    "RECRUITMENT_API_BASE_URL": {
        "description": "RecruitmentSystem HTTP API base URL",
        "prompt": "RecruitmentSystem API base URL",
        "url": None,
        "tools": ["recruitment_system_query", "recruitment_system_create_job"],
        "password": False,
        "category": "tool",
    },
    "RECRUITMENT_API_TENANT_ID": {
        "description": "Default RecruitmentSystem tenant ID sent as X-Tenant-Id",
    ...
    "RECRUITMENT_API_USER_ID": {
        "description": "Default RecruitmentSystem user ID sent as X-User-Id",
        "prompt": "RecruitmentSystem user ID",
        "url": None,
        "tools": ["recruitment_system_query", "recruitment_system_create_job"],
        "password": False,
        "category": "tool",
    ...
    "RECRUITMENT_API_TOKEN": {
        "description": "Optional bearer token for RecruitmentSystem HTTP APIs",
        "prompt": "RecruitmentSystem API token",
        "url": None,
        "tools": ["recruitment_system_query", "recruitment_system_create_job"],
        "password": True,
        "category": "tool",
    ...
    "RECRUITMENT_API_TIMEOUT_SECONDS": {
        "description": "RecruitmentSystem HTTP API timeout in seconds",
        "prompt": "RecruitmentSystem API timeout",
        "url": None,
        "tools": ["recruitment_system_query", "recruitment_system_create_job"],
        "password": False,
        "category": "tool",
    ...
    "RECRUITMENT_DEFAULT_DEPARTMENT": {
        "description": "Default department for RecruitmentSystem job creation",
        "prompt": "RecruitmentSystem default department",
        "url": None,
        "tools": ["recruitment_system_create_job"],
        "password": False,
        "category": "tool",
        "advanced": True,
    },
    "RECRUITMENT_DEFAULT_WORK_LOCATION": {
        "description": "Default work location for RecruitmentSystem job creation",
        "prompt": "RecruitmentSystem default work location",
        "url": None,
        "tools": ["recruitment_system_create_job"],
        "password": False,
        "category": "tool",
    ...
    "RECRUITMENT_DEFAULT_EMPLOYMENT_TYPE": {
        "description": "Default employment type for RecruitmentSystem job creation",
        "prompt": "RecruitmentSystem default employment type",
        "url": None,
        "tools": ["recruitment_system_create_job"],
        "password": False,
        "category": "tool",
    ...
    "RECRUITMENT_DEFAULT_HEADCOUNT": {
        "description": "Default headcount for RecruitmentSystem job creation",
        "prompt": "RecruitmentSystem default headcount",
        "url": None,
        "tools": ["recruitment_system_create_job"],
        "password": False,
        "category": "tool",
    ...
    "RECRUITMENT_DEFAULT_OWNER_USER_ID": {
        "description": "Default owner user ID for RecruitmentSystem job creation",
        "prompt": "RecruitmentSystem default owner user ID",
        "url": None,
        "tools": ["recruitment_system_create_job"],
        "password": False,
        "category": "tool",
    ...
    "RECRUITMENT_DEFAULT_OWNER_USER_NAME": {
        "description": "Default owner user name for RecruitmentSystem job creation",
        "prompt": "RecruitmentSystem default owner user name",
        "url": None,
        "tools": ["recruitment_system_create_job"],
        "password": False,
        "category": "tool",
