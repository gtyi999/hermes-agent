    ...
    for i, (tc, name, args, middleware_trace, _parse_error, _scope_block) in enumerate(
        ...
        if not blocked and agent.tool_progress_callback:
            try:
                ...
                result_preview = _multimodal_text_summary(display_function_result)[:200]
                agent.tool_progress_callback(
                    "tool.completed", progress_function_name, result_preview, display_args,
    ...
    for i, tool_call in enumerate(assistant_message.tool_calls, 1):
        ...
        if not _execution_blocked and agent.tool_progress_callback:
            try:
                ...
                result_preview = _multimodal_text_summary(display_function_result)[:200]
                agent.tool_progress_callback(
                    "tool.completed", function_name, result_preview, display_args,
