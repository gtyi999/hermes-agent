...
sidebar_label: "Bilibili Video Download"
description: "Download Bilibili video/audio media from bilibili.com or b23.tv links when the user asks to save an authorized B站/Bilibili video locally"
---
...
Download Bilibili video/audio media from bilibili.com or b23.tv links when the user asks to save an authorized B站/Bilibili video locally. Use for video media downloads from Bilibili URLs, BV/av links, bangumi episode links, or shortened b23.tv links; use the Bilibili subtitle skill for subtitles-only requests.
...
| Path | `skills/media/bilibili-video-download` |
