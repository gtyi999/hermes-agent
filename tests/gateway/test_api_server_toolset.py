...
class TestHermesApiServerToolset:
    ...
    def test_toolset_includes_recruitment_system_tools(self):
        tools = resolve_toolset("hermes-api-server")
        for tool in [
            "recruitment_system_query",
            "recruitment_system_create_job",
            "recruitment_system_health",
        ]:
            assert tool in tools, f"Missing recruitment tool: {tool}"
