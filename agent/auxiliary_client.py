...
#
# deepseek: the direct DeepSeek API currently exposes text-only chat/reasoning
# models.  Keep this static guard so a transient models.dev outage cannot turn
# an unknown capability into a doomed image request.
#
